...
namespace Microsoft.eShopOnDapr.Services.Flow.API;

public static class ProgramExtensions
{
    private const string AppName = "Flow API";
    ...
    public static void AddCustomAuthorization(this WebApplicationBuilder builder)
    {
        builder.Services.AddAuthorization(options =>
        {
            options.AddPolicy("ApiScope", policy =>
            {
                ...
                policy.RequireClaim("scope", "flow");
            });
        });
    }
    ...
    public static void AddCustomApplicationServices(this WebApplicationBuilder builder)
    {
        ...
        builder.Services.AddScoped<IFlowRepository, DaprFlowRepository>();
